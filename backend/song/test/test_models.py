...
class TestModel:
    ...
    def test_check_dead_artist_creation(self, dead_artist):
        ...
        assert dead_artist.is_still_alive == False

    def test_check_song_creation(self, song, category, album, artist):
    ...
    def test_check_song_creation_for_dead_artist(self, song_for_dead_artist, category, dead_artist):

        assert song_for_dead_artist.slug == 'ca-ne-bouge-pas'
        assert song_for_dead_artist.category == category
        assert song_for_dead_artist.artist == dead_artist

    def test_check_songLink_creation(self, song_link, song):

        assert song_link.provider == 'youtube'
        assert song_link.song == song
